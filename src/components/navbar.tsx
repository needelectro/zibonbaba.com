        ...
        <div className="w-full bg-[#0f172a] text-slate-300 py-2 px-4 text-xs font-semibold flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div className="relative group cursor-pointer flex items-center gap-1 hover:text-white transition-colors">
              ...
              <div className="absolute top-full left-0 mt-1 bg-white text-slate-800 shadow-xl border border-slate-100 rounded-lg py-1.5 w-32 hidden group-hover:block z-50">
                <button onClick={() => setLanguage('en')} className="w-full text-left px-3 py-1.5 text-xs hover:bg-slate-50 font-bold block">English</button>
                <button onClick={() => setLanguage('bn')} className="w-full text-left px-3 py-1.5 text-xs hover:bg-slate-50 font-bold block">বাংলা</button>
              </div>
            </div>
